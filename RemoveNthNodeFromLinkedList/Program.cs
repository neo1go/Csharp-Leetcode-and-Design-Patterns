...
public class Program
{
    ...
    public static LinkedListNode<int>? RemoveNthNodeFromEnd(LinkedList<int> myList, int n)
    {
        ...
        {
            myList.Remove(firstPtr.Next);  //der linke Pointer zeigt auf den Knoten bevor den zu löschenden Knoten.
                                           //Deswegen ist der zu löschende Knoten somit firstPtr.Next.
        }

        myList.RemoveFirst(); //hier wird der Dummy entfernt mittels framework-Funktion um die LinkedList wieder normal erscheinen zu lassen
                              //ohne eventuelle temporäre Knoten. 
