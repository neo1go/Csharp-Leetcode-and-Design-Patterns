...
namespace CountNumberofTeams
{
    ...
    {//Leetcode Nr. 1395 
        ...
        //entweder aufsteigen oder absteigend.
        //Zahlen sind einzigartig.
        ...
        public static (int, List<int[]>) countNumberOfTeams(int[] nums)
        ...
        {
            int r = 1;//bei 0 würde nach der ersten Iteration wegen modulo10 schon ein Break eingeführt.
        ...
        
        {
           ...
           (int ergebnis, List<int[]>ergebnisListe) = countNumberOfTeams(nums5);
