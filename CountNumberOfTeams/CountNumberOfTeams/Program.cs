...
namespace CountNumberofTeams
{
    ...
    {//Leetcode Nr. 1395 
        //Die Aufgabe besteht darin, aus einem Array jeweils 3er Gruppen von Teammitgliedern herauszufiltern, entweder aufsteigen oder absteigend
        ...
        //falls man sie ausgeben möchte. Ansonsten einfach den counter hochsetzen falls alle 3 Zustände zutreffen für asc und desc.       
         

        //Mit dieser Version lässt sich die Liste anzeigen
       // public static List<int[]> countNumberOfTeams(int[] nums)
        public static int countNumberOfTeams(int[] nums)
        {
           int count = 0;
            List<int[]> temp = new List<int[]>();

            for (int i = 0; i < nums.Length - 2; i++)// [i,_,_]
            {
