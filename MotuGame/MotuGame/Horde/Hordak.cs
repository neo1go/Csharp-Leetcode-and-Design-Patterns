...
{
    public class Hordak : HordeModel
    {
        public override string? Name { get; set; } = "Hordak";
        ...
        {
           //ruft irgendein Vieh , vielleicht Modulok ,auch wenn er schon vorher besiegt wurde - lustiger Sound-cue ala' "Moooodulok"
        }
    }
}
